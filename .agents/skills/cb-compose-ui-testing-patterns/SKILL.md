---
name: cb-compose-ui-testing-patterns
description: Chọn Compose UI test, semantics assertion, focus/key test, screenshot/integration test. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: compose-ui-testing-patterns
upstream-path: skills/compose-ui-testing-patterns
language: vi
---

# cb-compose-ui-testing-patterns

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `compose-ui-testing-patterns`.
...
Dùng skill này khi task liên quan đến: **Chọn Compose UI test, semantics assertion, focus/key test, screenshot/integration test.**
