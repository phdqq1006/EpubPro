---
name: compose-perf-understanding-stability-inference
description: Giải thích vì sao compiler phân loại stable/unstable/runtime/unknown. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: skydoves/compose-performance-skills
upstream-skill: understanding-stability-inference
upstream-path: stability/understanding-stability-inference
language: vi
---

# compose-perf-understanding-stability-inference

Nguồn gốc: chuyển thể standalone từ `skydoves/compose-performance-skills` / `understanding-stability-inference`.
...
Dùng skill này khi task liên quan đến: **Giải thích vì sao compiler phân loại stable/unstable/runtime/unknown.**
