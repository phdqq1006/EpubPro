---
name: android-media3-cast-integration
description: Tích hợp Media3 CastPlayer/CastOptions và state playback. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: media3-cast-integration
upstream-path: media/media3-cast-integration
language: vi
---

# android-media3-cast-integration

Nguồn gốc: chuyển thể standalone từ `android/skills` / `media3-cast-integration`.
...
Dùng skill này khi task liên quan đến: **Tích hợp Media3 CastPlayer/CastOptions và state playback.**
