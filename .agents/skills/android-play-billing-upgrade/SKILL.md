...
description: Nâng cấp Play Billing Library và migration purchase/subscription flow. Luôn xuất kết quả bằng tiếng Việt.
...
Nguồn gốc: chuyển thể standalone từ `android/skills` / `play-billing-library-version-upgrade`.
...
Dùng skill này khi task liên quan đến: **Nâng cấp Play Billing Library và migration purchase/subscription flow.**
