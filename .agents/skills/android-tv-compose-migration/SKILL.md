...
description: Migrate Android TV Leanback sang Compose for TV. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: leanback-to-compose-tv-migration
upstream-path: tv/leanback-to-compose-tv-migration
language: vi
---

# android-tv-compose-migration

Nguồn gốc: chuyển thể standalone từ `android/skills` / `leanback-to-compose-tv-migration`.
...
Dùng skill này khi task liên quan đến: **Migrate Android TV Leanback sang Compose for TV.**
