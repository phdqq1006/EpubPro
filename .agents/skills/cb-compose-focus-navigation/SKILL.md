---
name: cb-compose-focus-navigation
description: Thiết kế keyboard/TV/D-pad/focus-first navigation trong Compose. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: compose-focus-navigation
upstream-path: skills/compose-focus-navigation
language: vi
---

# cb-compose-focus-navigation

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `compose-focus-navigation`.
...
Dùng skill này khi task liên quan đến: **Thiết kế keyboard/TV/D-pad/focus-first navigation trong Compose.**
