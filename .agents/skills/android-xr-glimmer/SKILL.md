...
description: Xây UI XR/display glasses với Jetpack Compose Glimmer. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: display-glasses-with-jetpack-compose-glimmer
upstream-path: xr/display-glasses-with-jetpack-compose-glimmer
language: vi
---

# android-xr-glimmer

Nguồn gốc: chuyển thể standalone từ `android/skills` / `display-glasses-with-jetpack-compose-glimmer`.
...
Dùng skill này khi task liên quan đến: **Xây UI XR/display glasses với Jetpack Compose Glimmer.**
