---
name: compose-perf-hot-reload-limits
description: Hiểu giới hạn hot reload: schema change, inline, constructor, resource ID. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: skydoves/compose-performance-skills
upstream-skill: understanding-hot-reload-limits
upstream-path: hot-reload/understanding-hot-reload-limits
language: vi
---

# compose-perf-hot-reload-limits

Nguồn gốc: chuyển thể standalone từ `skydoves/compose-performance-skills` / `understanding-hot-reload-limits`.
...
Dùng skill này khi task liên quan đến: **Hiểu giới hạn hot reload: schema change, inline, constructor, resource ID.**
