---
name: android-appfunctions
description: Tích hợp Android App Functions/service entry point cho tác vụ AI/device. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: appfunctions
upstream-path: device-ai/appfunctions
language: vi
---

# android-appfunctions

Nguồn gốc: chuyển thể standalone từ `android/skills` / `appfunctions`.
...
Dùng skill này khi task liên quan đến: **Tích hợp Android App Functions/service entry point cho tác vụ AI/device.**
