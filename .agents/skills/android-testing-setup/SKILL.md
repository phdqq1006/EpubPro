...
description: Thiết lập test Android/Compose: unit, instrumentation, Hilt, screenshot/preview. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: testing-setup
upstream-path: testing/testing-setup
language: vi
---

# android-testing-setup

Nguồn gốc: chuyển thể standalone từ `android/skills` / `testing-setup`.
...
Dùng skill này khi task liên quan đến: **Thiết lập test Android/Compose: unit, instrumentation, Hilt, screenshot/preview.**
