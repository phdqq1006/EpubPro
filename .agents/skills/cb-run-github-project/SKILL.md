---
name: cb-run-github-project
description: Chạy/triage GitHub Project với planning lane và pipeline có gate. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: run-github-project
upstream-path: skills/run-github-project
language: vi
---

# cb-run-github-project

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `run-github-project`.
...
Dùng skill này khi task liên quan đến: **Chạy/triage GitHub Project với planning lane và pipeline có gate.**
