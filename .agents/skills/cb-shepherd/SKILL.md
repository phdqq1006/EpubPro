---
name: cb-shepherd
description: Theo dõi PR/MR, review comments, CI failures và giữ PR tiến triển. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: shepherd
upstream-path: skills/shepherd
language: vi
---

# cb-shepherd

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `shepherd`.
...
Dùng skill này khi task liên quan đến: **Theo dõi PR/MR, review comments, CI failures và giữ PR tiến triển.**
