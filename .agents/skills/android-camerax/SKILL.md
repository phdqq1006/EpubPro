---
name: android-camerax
description: Thiết kế, migrate, debug và kiểm thử CameraX. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: camerax
upstream-path: camera/camerax
language: vi
---

# android-camerax

Nguồn gốc: chuyển thể standalone từ `android/skills` / `camerax`.
...
Dùng skill này khi task liên quan đến: **Thiết kế, migrate, debug và kiểm thử CameraX.**
