---
name: cb-kotlin-control-flow
description: Viết/review Kotlin when, guard, sealed exhaustiveness, smart cast, nullable, early return. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: kotlin-control-flow
upstream-path: skills/kotlin-control-flow
language: vi
---

# cb-kotlin-control-flow

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `kotlin-control-flow`.
...
Dùng skill này khi task liên quan đến: **Viết/review Kotlin when, guard, sealed exhaustiveness, smart cast, nullable, early return.**
