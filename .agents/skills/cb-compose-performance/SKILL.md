---
name: cb-compose-performance
description: Chẩn đoán stability, recomposition, deferred reads và jank từ bằng chứng runtime. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: compose-performance
upstream-path: skills/compose-performance
language: vi
---

# cb-compose-performance

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `compose-performance`.
...
Dùng skill này khi task liên quan đến: **Chẩn đoán stability, recomposition, deferred reads và jank từ bằng chứng runtime.**
