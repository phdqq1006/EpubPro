---
name: android-cli
description: Dùng Android CLI để cài skill, tương tác project và thiết bị. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: android-cli
upstream-path: devtools/android-cli
language: vi
---

# android-cli

Nguồn gốc: chuyển thể standalone từ `android/skills` / `android-cli`.
...
Dùng skill này khi task liên quan đến: **Dùng Android CLI để cài skill, tương tác project và thiết bị.**
