---
name: cb-to-plan
description: Tạo implementation plan repo-aware từ issue/task sẵn sàng. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: to-plan
upstream-path: skills/to-plan
language: vi
---

# cb-to-plan

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `to-plan`.
...
Dùng skill này khi task liên quan đến: **Tạo implementation plan repo-aware từ issue/task sẵn sàng.**
