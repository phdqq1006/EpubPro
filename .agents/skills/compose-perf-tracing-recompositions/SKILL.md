---
name: compose-perf-tracing-recompositions
description: Trace recomposition runtime với TraceRecomposition/log/metric. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: skydoves/compose-performance-skills
upstream-skill: tracing-recompositions-at-runtime
upstream-path: measurement/tracing-recompositions-at-runtime
language: vi
---

# compose-perf-tracing-recompositions

Nguồn gốc: chuyển thể standalone từ `skydoves/compose-performance-skills` / `tracing-recompositions-at-runtime`.
...
Dùng skill này khi task liên quan đến: **Trace recomposition runtime với TraceRecomposition/log/metric.**
