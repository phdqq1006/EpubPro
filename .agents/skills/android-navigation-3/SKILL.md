...
description: Thiết kế/migrate Navigation 3, back stack, typed destinations và deep link. Luôn xuất kết quả bằng tiếng Việt.
...
Nguồn gốc: chuyển thể standalone từ `android/skills` / `navigation-3`.
...
Dùng skill này khi task liên quan đến: **Thiết kế/migrate Navigation 3, back stack, typed destinations và deep link.**
