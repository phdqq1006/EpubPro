...
description: Hướng dẫn record/analyze trace bằng Android Studio Profiler/Perfetto. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: android-profiler
upstream-path: profilers/android-profiler
language: vi
---

# android-profiler

Nguồn gốc: chuyển thể standalone từ `android/skills` / `android-profiler`.
...
Dùng skill này khi task liên quan đến: **Hướng dẫn record/analyze trace bằng Android Studio Profiler/Perfetto.**
