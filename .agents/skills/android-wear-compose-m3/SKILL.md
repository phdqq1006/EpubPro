---
name: android-wear-compose-m3
description: Migrate/thiết kế Wear Compose Material 3. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: wear-compose-m3
upstream-path: wear/wear-compose-m3
language: vi
---

# android-wear-compose-m3

Nguồn gốc: chuyển thể standalone từ `android/skills` / `wear-compose-m3`.
...
Dùng skill này khi task liên quan đến: **Migrate/thiết kế Wear Compose Material 3.**
