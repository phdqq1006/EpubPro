...
description: Triển khai edge-to-edge, system bars, window insets và IME inset. Luôn xuất kết quả bằng tiếng Việt.
...
Nguồn gốc: chuyển thể standalone từ `android/skills` / `edge-to-edge`.
...
Dùng skill này khi task liên quan đến: **Triển khai edge-to-edge, system bars, window insets và IME inset.**
