---
name: android-engage-sdk-integration
description: Tích hợp Google Play Engage SDK theo vertical/schema phù hợp. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: android/skills
upstream-skill: engage-sdk-integration
upstream-path: play/engage-sdk-integration
language: vi
---

# android-engage-sdk-integration

Nguồn gốc: chuyển thể standalone từ `android/skills` / `engage-sdk-integration`.
...
Dùng skill này khi task liên quan đến: **Tích hợp Google Play Engage SDK theo vertical/schema phù hợp.**
