---
name: cb-kotlin-api-design
description: Thiết kế function owner, semantic domain type, KMP expect/actual boundary. Luôn xuất kết quả bằng tiếng Việt.
argument-hint: "<mục tiêu, diff, file hoặc lỗi cần xử lý>"
user-invocable: true
source-repo: chrisbanes/skills
upstream-skill: kotlin-api-design
upstream-path: skills/kotlin-api-design
language: vi
---

# cb-kotlin-api-design

Nguồn gốc: chuyển thể standalone từ `chrisbanes/skills` / `kotlin-api-design`.
...
Dùng skill này khi task liên quan đến: **Thiết kế function owner, semantic domain type, KMP expect/actual boundary.**
